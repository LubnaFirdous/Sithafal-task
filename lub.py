...
class RAGPipeline:
    def __init__(self, api_key):
        ...
        self.llm = OpenAI(
            model_name="gpt-3.5-turbo",  # Updated to use a supported model
        ...
        try:
            self.llm = OpenAI(
                model_name="gpt-3.5-turbo",
                 OPENAI_API_KEY="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"
